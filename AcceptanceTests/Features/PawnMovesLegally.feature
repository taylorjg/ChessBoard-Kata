...
Scenario: Pawn starts on home row and moves 1 space
...
Scenario: Pawn starts on home row and moves 2 spaces
Given the game has just started
...
Scenario: Pawn cannot move 2 spaces when not first round
Given the game has not just started
And the Pawn is on D2
And the Knight is at G8
When I move the Pawn to D4
Then I should be shown "Pawn cannot move 2 spaces unless it is the first round and is on the home row."
